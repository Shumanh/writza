...
<form onSubmit={handleSubmit} className="h-full w-2/3 m-auto flex-col relative top-30 ">
...
<h1 className = "text-xl text-center font-bold">
 ...
 />
  {errors.shortDescription&& <p className="text-red-500 mt-1">{errors.shortDescription}</p>}
...
<div className="flex justify-center mt-3">
            ...
            <Link href="/blogs/view" className="ml-1 border-b-1">See all blogs</Link> 
          </div>
