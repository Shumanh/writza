  ...
  return (
    <section className="w-full flex h-[80vh] items-center justify-between gap-8 px-6 pt-16 md:pt-20">
      <div>
        ...
        <div className="mb-6">
          <span className="text-lg bg-gradient-to-r from-primary to-primary/80 text-transparent bg-clip-text font-semibold tracking-wide">TECH BLOGS FROM</span>
          <h2 className="font-bold text-2xl md:text-3xl tracking-tight text-primary mt-1">DEVSG</h2>
        </div>
