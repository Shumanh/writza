export default function Hero() {
  return (
    <section className="w-full h-full flex flex-col justify-center items-center px-4 sm:px-6 py-4">
      <div className="max-w-4xl text-center animate-fadeIn">
        ...
        <h1 className="font-bold text-3xl sm:text-5xl md:text-6xl leading-tight sm:leading-snug text-primary animate-slideUp [animation-delay:300ms] opacity-0 px-2">
          Because the Future
          <br className="hidden sm:block" />
          <span className="sm:hidden"> </span>Belongs to You.
        </h1>

        <p className="mt-3 sm:mt-5 text-base sm:text-lg md:text-xl text-primary/70 mx-auto max-w-2xl animate-slideUp [animation-delay:600ms] opacity-0 px-2">
          Read the tech stories and experiences from DEVSG. Discover insights that shape the future of technology.
        </p>

        <div className="mt-6 sm:mt-8 flex justify-center items-center gap-4 animate-slideUp [animation-delay:900ms] opacity-0">
          <a
            href="/blogs/view"
